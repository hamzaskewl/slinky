...
export default function AccountTab() {
  ...
  const getTemplateColor = (name: string) => {
    switch (name) {
      case "ClaimLink": return "bg-white/5 text-slate-300 border-white/10";
      case "ClaimReceipt": return "bg-white/5 text-slate-300 border-white/10";
      case "ClaimNotification": return "bg-white/5 text-slate-400 border-white/10";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-slate-400">
              ...
              <code className="text-slate-300 text-xs" title={user.partyId}>
        ...
        <button
          onClick={loadData}
          className="flex items-center gap-2 px-4 py-2 rounded-lg bg-surface-raised border border-surface-border text-slate-200 hover:border-surface-light transition-all"
        >
      ...
      <div className="bg-surface-raised border border-surface-border rounded-xl p-4">
        <div className="flex items-center gap-4 flex-wrap">
          <div className="flex items-center gap-2">
            ...
            <code className="text-sm text-slate-300">{user.partyHint}</code>
          </div>
      ...
      <div className="bg-surface-raised border border-surface-border rounded-xl p-6">
        ...
        {user.role === "sender" ? (
          <ul className="space-y-2 text-sm text-slate-400">
            <li className="flex items-center gap-2"><span className="text-slate-300">&#10003;</span> ClaimLink contracts you created</li>
            <li className="flex items-center gap-2"><span className="text-slate-300">&#10003;</span> ClaimNotifications when your links are claimed</li>
            <li className="flex items-center gap-2"><span className="text-slate-300">&#10003;</span> RevokedLink records for links you cancelled</li>
          ...
          <ul className="space-y-2 text-sm text-slate-400">
            <li className="flex items-center gap-2"><span className="text-slate-300">&#10003;</span> ClaimReceipts for payments you've claimed</li>
          ...
          <div className="space-y-3">
            {contracts.map((contract) => (
              <div
                ...
                className="bg-surface-raised border border-surface-border rounded-xl p-4 flex items-center justify-between hover:border-surface-light transition-all"
              >
                <div className="flex items-center gap-3">
